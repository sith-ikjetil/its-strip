...
namespace ItSoftware::ItsStrip
{
    ...
    int ParseArguments(int argc, const char* argv[], ItsStripArguments& args);
...
//      Redirects to ItSoftware::ItsStrip::main.
//
int main(int argc, const char* argv[])
{
    return ItSoftware::ItsStrip::main(argc, argv);
}